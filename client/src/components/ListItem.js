    ...
    return (
        <li className='list-group-item'>
            ...
            <div className='row'>
                ...
                <p onClick={props.newSubscription} className='btn text-muted m-2'><small>Subscribe</small></p>
                ...
                {props.isCorrectUser && (
                    <p onClick={props.removeReading} className='btn text-danger m-2'>
                        <small>Delete</small>
                    </p>
                )}
                {props.summary.id == props.id &&
                    <p>{props.summary.data}</p>
                }
            </div>
        </li>
    )
